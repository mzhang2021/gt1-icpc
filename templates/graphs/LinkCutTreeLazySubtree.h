/**
 * Description: Link cut tree that supports both path and subtree lazy simultaneously.
 * Author: 12tqian
 * Source: https://12tqian.github.io/cp-library/library/graphs/link-cut-tree.hpp

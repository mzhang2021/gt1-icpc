/**
 * Description: Finds a weighted matching in a general graph.
 * Author: benq
 * Source: https://github.com/bqi343/USACO/blob/master/Implementations/content/graphs%20(12)/Matching/WeightedMatch.h
 * Time: O(n^3)
 */
